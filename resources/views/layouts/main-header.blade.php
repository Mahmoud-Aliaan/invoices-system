					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
								...
								<div class="dropdown-menu">
									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											...
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a href="/markAsRead">تعين قراءة الجميع</a></span>
										</div>
										<div class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="Notifications_count">لديك اشعارات غير مقرؤة {{Auth::user()->unreadNotifications()->count()}}</div>
									</div>
									
									{{-- start location notifcations --}}
									<div id="unreadNotifications">
										<div class="main-notification-list Notification-scroll">
											...
											<a class="d-flex p-3 border-bottom" href="{{url('InvoicesDetails')}}/{{$Notifications->data['id']}}">
												<div class="notifyimg bg-pink">
													<i class="la la-file-alt text-white"></i>
												</div>
												<div class="mr-3">
													<h5 class="notification-label mb-1">
														{{$Notifications->data['title'] }}  {{$Notifications->data['user'] }}<br>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/faces/logo.png')}}"></a>
								<div class="dropdown-menu">
