			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/faces/logo.png')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
						<div class="user-info">
				...
				<ul class="side-menu">
					...
					@endcan 
					<!--______  نهايه الفواتير ______-->
					
					<!--______  بدايه التقارير ______-->
					@can('التقارير')
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								@can('تقرير الفواتير') 
									<li><a class="slide-item" href="{{ url('/' . $page='invoice_reborts') }}">تقارير الفواتير</a></li>
								@endcan

								@can('تقرير العملاء') 
									<li><a class="slide-item" href="{{ url('/' . $page='customers_reborts') }}">تقارير العملاء</a></li>
								@endcan
					...
					<!--______  بدايه  المستخدمين ______-->
					@can('المستخدمين') 
					...
					@endcan
					<!--______  نهايه المستخدمين ______-->
					
					<!--______  بدايه  الاعدادات ______-->
					@can('الاعدادات') 
