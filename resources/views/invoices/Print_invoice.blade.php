...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ معاينه طباعه الفااتورة</span>
						</div>
					</div>
							...
							<div class="card card-invoice" id="print">
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											<label class="tx-gray-600">معلومات الفااتورة</label>
											<p class="invoice-info-row"><span>رقم الفااتورة</span> <span>{{$invoice->invoice_number}}</span></p>
											<p class="invoice-info-row"><span> تارريخ الاصدار : </span> <span>{{$invoice->invoice_Date}}</span></p>
									...
									<div class="table-responsive mg-t-40">
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													<td class="tx-right">نسبه الخصم</td>
